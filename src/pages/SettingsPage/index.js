        ...
        <div className="settings-header-text ">
          ...
          <div className="settings-header-text-others">
            <div>
              ...
              <Input defaultValue={user.mobilePhone || ''} placeholder="Mobile phone" />
            </div>
            <div>
              ...
              <Input defaultValue={user.instProfile || ''} placeholder="Instagram" />
            </div>
            <div >
              ...
              <Input defaultValue={user.mail || ''} placeholder="E-mail" />
            </div>
          </div>
        </div>
      </div>
